  ...
  return (
    <div className="home">
      ...
      <div className="home__row">
        <Product
          id="12321341"
          title="The Lean Startup: How Constant Innvation Creates Radically Businesses Paperback"
          price={11.96}
          rating={5}
        ...
        <Product
          id="49538094"
          title="The Lean Startup: How Constant Innvation Creates"
          price={239.0}
          rating={4}
      ...
      <div className="home__row">
        <Product
          id="12321368"
          title="Samsung LC49RG90SSUXEN 49' Curved LED Gaming Monitor - Super Ultra wide Dul WQHD 5120 X 1440"
          price={1094.98}
          rating={4}
